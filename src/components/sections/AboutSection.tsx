            ...
            <div className="text-center lg:text-left">
              <div className="relative inline-block mb-8">
                <div className="w-64 h-64 rounded-full overflow-hidden glass-card border-4 border-primary/30 neon-glow mx-auto lg:mx-0">
                  <img 
                    src="https://i.postimg.cc/kgMWbQJw/PSIZE-IMG.jpg"
                    alt="Mopuri Saikumar Reddy"
                    className="w-full h-full object-cover"
                  />
                </div>
                <div className="absolute -inset-4 border-2 border-accent/20 rounded-full animate-spin" style={{ animationDuration: '20s' }} />
              </div>
            </div>
          </ScrollFadeIn>
          ...
          <ScrollFadeIn delay={400}>
            <div className="space-y-6">
              <div className="glass-card p-8">
                <h3 className="text-2xl font-bold mb-4 text-primary">Passionate Developer</h3>
              ...
              <div className="space-y-6">
                ...
                {Object.entries(skills).map(([category, skillList], index) => (
                  <ScrollFadeIn key={category} delay={600 + index * 100}>
